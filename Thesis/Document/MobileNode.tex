...
\section{\ac{QMP} firmware basics}\footnote{http://qmp.cat}

\subsection{Main Features}

\ac{QMP} is an Operating System designed for embedded devices, a firmware. The main features of this firmware are:
...
\hline RP\_ADV & Rx probe advertisement. Used for reporting about reception rate of hello messages from neighbouring nodes.\\
...
This thesis has mostly followed a trial and error methodology during the experiments. In general terms, has also, somehow, followed an agile approach. 
